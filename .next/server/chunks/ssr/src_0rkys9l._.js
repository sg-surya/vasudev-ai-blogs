...
4. **NotebookLM**: Google's free AI notebook that excels at ingesting massive class syllabus PDFs and generating audio podcasts or study guides from them.
    `,coverImage:"https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=1200&auto=format&fit=crop",date:"2026-04-05",readingTime:"4 min read",category:"Artificial Intelligence",tags:["Students","Productivity","Free Tools"],author:b}],d=Array.from(new Set(c.map(a=>a.category)));a.s(["categories",0,d,"posts",0,c])},56455,a=>{"use strict";var b=a.i(87924),c=a.i(50944),d=a.i(46271),e=a.i(38246),f=a.i(28861),g=a.i(56711);a.s(["CategoriesContent",0,function({posts:a}){let h=(0,c.useSearchParams)(),i=(0,c.useRouter)(),j=h?.get("q")||"All",k=a=>{a.q?i.push(`?q=${a.q}`):i.push("?")},l="All"===j?a:a.filter(a=>a.category===j);return(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20",children:[(0,b.jsxs)("div",{className:"text-center mb-16",children:[(0,b.jsx)("h1",{className:"text-4xl md:text-6xl font-serif font-bold tracking-tight mb-6",children:"Topics & Modules"}),(0,b.jsx)("p",{className:"text-xl text-muted-foreground max-w-2xl mx-auto",children:"Explore specific domains of systems engineering, AI research, and architecture."})]}),(0,b.jsxs)("div",{className:"flex flex-wrap justify-center gap-3 mb-16",children:[(0,b.jsx)("button",{onClick:()=>k({}),className:`px-6 py-2.5 rounded-full text-sm font-medium transition-all shadow-sm border ${"All"===j?"bg-foreground text-background border-foreground":"bg-card text-foreground border-border hover:border-teal/50 hover:text-teal"}`,children:"All Signals"}),f.categories.map(a=>(0,b.jsx)("button",{onClick:()=>k({q:a}),className:`px-6 py-2.5 rounded-full text-sm font-medium transition-all shadow-sm border ${j===a?"bg-foreground text-background border-foreground":"bg-card text-foreground border-border hover:border-teal/50 hover:text-teal"}`,children:a},a))]}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",children:l.map((a,c)=>(0,b.jsxs)(d.motion.article,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{delay:.05*c},className:"group flex flex-col bg-card border border-border rounded-2xl overflow-hidden hover:shadow-lg transition-all hover:border-teal/30 relative",children:[(0,b.jsx)(e.default,{href:`/article/${a.slug}`,className:"absolute inset-0 z-10"}),(0,b.jsxs)("div",{className:"flex flex-col flex-grow p-6",children:[(0,b.jsx)("span",{className:"text-xs font-semibold tracking-wider uppercase text-teal mb-4 block",children:a.category}),(0,b.jsx)("h3",{className:"text-xl font-serif font-bold mb-3 group-hover:text-teal transition-colors line-clamp-2",children:a.title}),(0,b.jsx)("p",{className:"text-muted-foreground text-sm line-clamp-3 mb-6 flex-grow",children:a.excerpt}),(0,b.jsxs)("div",{className:"pt-4 border-t border-border mt-auto flex items-center justify-between text-xs font-medium text-muted-foreground",children:[(0,b.jsx)("span",{children:(0,g.format)(new Date(a.date),"MMM d, yyyy")}),(0,b.jsx)("span",{className:"font-mono",children:a.readingTime})]})]})]},a.id))}),0===l.length&&(0,b.jsx)("div",{className:"py-24 text-center",children:(0,b.jsx)("p",{className:"text-xl font-serif text-muted-foreground",children:"No records found in this sector."})})]})}])}];

//# sourceMappingURL=src_0rkys9l._.js.map