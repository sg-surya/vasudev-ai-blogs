...
4. **NotebookLM**: Google's free AI notebook that excels at ingesting massive class syllabus PDFs and generating audio podcasts or study guides from them.
    `,coverImage:"https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=1200&auto=format&fit=crop",date:"2026-04-05",readingTime:"4 min read",category:"Artificial Intelligence",tags:["Students","Productivity","Free Tools"],author:b}],d=Array.from(new Set(c.map(a=>a.category)));a.s(["categories",0,d,"posts",0,c])},41445,a=>{"use strict";a.s(["ArticlesArchive",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call ArticlesArchive() from the server but ArticlesArchive is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/components/ArticlesArchive.tsx <module evaluation>","ArticlesArchive")},74484,a=>{"use strict";a.s(["ArticlesArchive",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call ArticlesArchive() from the server but ArticlesArchive is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/components/ArticlesArchive.tsx","ArticlesArchive")},96743,a=>{"use strict";a.i(41445);var b=a.i(74484);a.n(b)},23480,a=>{"use strict";var b=a.i(7997),c=a.i(28276),d=a.i(96743);a.s(["default",0,function(){return(0,b.jsxs)("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12",children:[(0,b.jsxs)("div",{className:"max-w-3xl mb-12",children:[(0,b.jsx)("h1",{className:"text-4xl md:text-5xl font-serif font-bold text-foreground tracking-tight mb-6",children:"The Archive"}),(0,b.jsx)("p",{className:"text-lg text-muted-foreground",children:"Thoughts on AI, machine learning engineering, Android modding, and everything in between."})]}),(0,b.jsx)(d.ArticlesArchive,{posts:c.posts})]})},"metadata",0,{title:"Articles Archive",description:"Browse all articles on AI, machine learning, Android customization, and developer tools."}])},19512,a=>{a.n(a.i(23480))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0q25x1a._.js.map