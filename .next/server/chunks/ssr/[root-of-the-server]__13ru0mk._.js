...
4. **NotebookLM**: Google's free AI notebook that excels at ingesting massive class syllabus PDFs and generating audio podcasts or study guides from them.
    `,coverImage:"https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=1200&auto=format&fit=crop",date:"2026-04-05",readingTime:"4 min read",category:"Artificial Intelligence",tags:["Students","Productivity","Free Tools"],author:b}],d=Array.from(new Set(c.map(a=>a.category)));a.s(["categories",0,d,"posts",0,c])},22160,a=>{"use strict";var b=a.i(7997),c=a.i(95936),d=a.i(28276);a.s(["default",0,function(){return(0,b.jsxs)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-20 font-sans",children:[(0,b.jsx)("h1",{className:"text-4xl md:text-5xl font-serif font-bold tracking-tight mb-8",children:"HTML Sitemap"}),(0,b.jsx)("p",{className:"text-muted-foreground mb-12 text-lg",children:"An overview of the complete architecture and available nodes on Surya AI Chronicles."}),(0,b.jsxs)("div",{className:"grid md:grid-cols-2 gap-12",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("h2",{className:"text-2xl font-serif font-bold mb-6 border-b border-border pb-2",children:"Core Pages"}),(0,b.jsx)("ul",{className:"space-y-3 mb-10",children:[{title:"Home",path:"/"},{title:"Articles Archive",path:"/articles"},{title:"Categories",path:"/categories"},{title:"About Surya",path:"/about"},{title:"Contact",path:"/contact"}].map(a=>(0,b.jsx)("li",{children:(0,b.jsx)(c.default,{href:a.path,className:"text-muted-foreground hover:text-teal transition-colors",children:a.title})},a.path))}),(0,b.jsx)("h2",{className:"text-2xl font-serif font-bold mb-6 border-b border-border pb-2",children:"Legal & Compliance"}),(0,b.jsx)("ul",{className:"space-y-3",children:[{title:"Privacy Policy",path:"/privacy"},{title:"Terms & Conditions",path:"/terms"},{title:"Disclaimer",path:"/disclaimer"},{title:"Cookie Policy",path:"/cookie"}].map(a=>(0,b.jsx)("li",{children:(0,b.jsx)(c.default,{href:a.path,className:"text-muted-foreground hover:text-teal transition-colors",children:a.title})},a.path))})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("h2",{className:"text-2xl font-serif font-bold mb-6 border-b border-border pb-2",children:"Topic Modules"}),(0,b.jsx)("ul",{className:"space-y-3 mb-10",children:d.categories.map(a=>(0,b.jsx)("li",{children:(0,b.jsx)(c.default,{href:`/categories?q=${encodeURIComponent(a)}`,className:"text-muted-foreground hover:text-teal transition-colors",children:a})},a))}),(0,b.jsx)("h2",{className:"text-2xl font-serif font-bold mb-6 border-b border-border pb-2",children:"Article Database"}),(0,b.jsx)("ul",{className:"space-y-3",children:d.posts.map(a=>(0,b.jsx)("li",{children:(0,b.jsx)(c.default,{href:`/article/${a.slug}`,className:"text-muted-foreground hover:text-teal transition-colors line-clamp-1",children:a.title})},a.slug))})]})]})]})}])},93669,a=>{a.n(a.i(22160))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__13ru0mk._.js.map